    ...
    return (<div style={{marginTop:"-100px"}}>
        ...
        <div className='col-lg-12 control-section'>
            <div className='control-wrapper'>
                <ScheduleComponent width='100%' height='650px' selectedDate={new Date()} ref={scheduleObj} eventSettings={{ dataSource: data, fields: fields }} editorTemplate={editorTemplate}  editorHeaderTemplate={editorHeaderTemplate} actionBegin={onActionBegin} showQuickInfo={false} eventRendered={onEventRendered} readonly={true}>
                    <ViewsDirective>
